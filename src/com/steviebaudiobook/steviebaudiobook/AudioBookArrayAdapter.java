...
public class AudioBookArrayAdapter extends ArrayAdapter<ABChapter> implements HorizontalListView.AdapterComm {
	...
	File extDir = new File(Environment.getExternalStorageDirectory() + "/Android/data/com.stevieb.stevieb/files/");
	long chapterSize;
	int position;
	String chapterFile;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		File file = new File(Environment.getExternalStorageDirectory() + "/Android/data/com.stevieb.stevieb/files/" + chapterFile);
	...
	public void updateProgress() {
		Log.d("progress", Long.toString(rowItem.getAudioProgress()));
		Log.d("length", Long.toString(rowItem.getAudioLength()));
		Log.d("percent", Integer.toString(progress));
